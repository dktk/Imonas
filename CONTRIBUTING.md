...
# Razor Page Clean Architecture

# Information and Guidelines for Contributors
Thank you for contributing to Razor Page Clean Architecture and making it even better. We are happy about every contribution! Issues, bug-fixes, new components...
...
- Razor Page Clean Architecture supports RTL. It basically mirrors the ui horizontally for languages which are read right-to-left. See [RTL guide](https://rtlstyling.com/posts/rtl-styling)  for more information. Therefore every component should implement this functionality.
...
Razor Page Clean Architecture is divided in different projects. The most important ones are:
- [Razor Page Clean Architecture](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture): contains all components
- [Razor Page Clean Architecture.Docs](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture.Docs): contains the [docs](https://Razor Page Clean Architecture.com/)
- [Razor Page Clean Architecture.UnitTests](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture.Docs): contains bUnit tests for all components
- [Razor Page Clean Architecture.UnitTests.Viewer](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture.Docs): a visual representation of the unit tests. When you launch the project, you can test whether the components look and behave correctly

Most important files:
- Component `.razor` and `.razor.cs` classes ([Link](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture/Components))
- Component `.scss` style classes ([Link](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture/Styles/components))
- Enums ([Link](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture/Enums))
- Component doc pages ([Link](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture.Docs/Pages/Components))
- Component tests ([Link](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture.UnitTests/Components))
- Test components ([Link](https://github.com/Garderoben/Razor Page Clean Architecture/tree/dev/src/Razor Page Clean Architecture.UnitTests.Viewer/TestComponents))
...
In Razor Page Clean Architecture.UnitTests.Viewer create a razor file that instantiates your component
and binds it to a public field.

In Razor Page Clean Architecture.UnitTests create another test (i.e. by copying CheckBoxTests.cs and renaming it)
...
### What is the Razor Page Clean Architecture.UnitTests.Viewer for?
