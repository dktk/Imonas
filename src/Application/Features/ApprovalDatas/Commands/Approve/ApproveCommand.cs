...
namespace Application.Features.ApprovalDatas.Commands.Approve
{
    public class ApproveCommand : IRequest<Result<bool>>
    {
    ...
    public class ApproveCommandHandler : IRequestHandler<ApproveCommand,Result<bool>>
    {
        ...
        public async Task<Result<bool>> Handle(ApproveCommand request, CancellationToken cancellationToken)
        {
