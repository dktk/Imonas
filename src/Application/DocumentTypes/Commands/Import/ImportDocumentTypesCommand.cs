...
namespace Application.DocumentTypes.Commands.Import
{
    public class ImportDocumentTypesCommand : IRequest<Result<bool>>
    {
    ...
    public class ImportDocumentTypesCommandHandler :
        ...
        IRequestHandler<ImportDocumentTypesCommand,Result<bool>>
    {
        ...
        public async Task<Result<bool>> Handle(ImportDocumentTypesCommand request, CancellationToken cancellationToken)
        {
