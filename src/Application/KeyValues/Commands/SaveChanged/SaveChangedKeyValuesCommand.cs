...
using Application.KeyValues.Caching;
using Application.KeyValues.DTOs;

using SG.Common;

namespace Application.KeyValues.Commands.SaveChanged
{
    public class SaveChangedKeyValuesCommand:IRequest<Result<bool>>, ICacheInvalidator
    {
    ...
    public class SaveChangedKeyValuesCommandHandler : IRequestHandler<SaveChangedKeyValuesCommand,Result<bool>>
    {
        ...
        public async Task<Result<bool>> Handle(SaveChangedKeyValuesCommand request, CancellationToken cancellationToken)
        {
