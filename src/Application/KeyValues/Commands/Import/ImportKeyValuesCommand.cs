...
namespace Application.KeyValues.Commands.Import
{
    public class ImportKeyValuesCommand : IRequest<Result<bool>>
    {
    ...
    public class ImportKeyValuesCommandHandler :
        ...
        IRequestHandler<ImportKeyValuesCommand,Result<bool>>
    {
        ...
        public async Task<Result<bool>> Handle(ImportKeyValuesCommand request, CancellationToken cancellationToken)
        {
