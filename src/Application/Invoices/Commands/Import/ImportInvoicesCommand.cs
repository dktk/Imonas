...
namespace Application.Invoices.Commands.Import
{
    public class ImportInvoicesCommand: IRequest<Result<bool>>
    {
    ...
    public class ImportInvoicesCommandHandler : 
                 ...
                 IRequestHandler<ImportInvoicesCommand,Result<bool>>
    {
        ...
        public async Task<Result<bool>> Handle(ImportInvoicesCommand request, CancellationToken cancellationToken)
        {
