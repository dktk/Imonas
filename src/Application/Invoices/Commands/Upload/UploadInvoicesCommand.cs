...
{
    public class UploadInvoicesCommand: IRequest<Result<bool>>
    {
    ...
    public class UploadInvoicesCommandHandler : 
                 IRequestHandler<UploadInvoicesCommand,Result<bool>>
    {
        ...
        public async Task<Result<bool>> Handle(UploadInvoicesCommand request, CancellationToken cancellationToken)
        {
