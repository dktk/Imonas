...
namespace Application.Customers.Commands.Import
{
    public class ImportCustomersCommand : IRequest<Result<bool>>, ICacheInvalidator
    {
    ...
    public class ImportCustomersCommandHandler :
        ...
        IRequestHandler<ImportCustomersCommand,Result<bool>>
    {
        ...
        public async Task<Result<bool>> Handle(ImportCustomersCommand request, CancellationToken cancellationToken)
        {
            ...
            if (result.Success)
            {
                ...
                if (errorsOccurred)
                {
                    return Result<bool>.CreateFailure(errors);
                }
            ...
            {
                return Result<bool>.CreateFailure(result.Errors);
            }
        }
