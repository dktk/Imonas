...
using Infrastructure.Constants.ClaimTypes;
using SG.Common;
...
namespace SmartAdmin.WebUI.Areas.Authorization.Pages
{
    ...
    public class RoleModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                return BadRequest(Result<bool>.CreateFailure(new string[] { e.Message }));
            }
        }
        ...
        public async Task<IActionResult> OnGetDeleteAsync(string id)
        {
            ...
            if (role.Name == "Admin")
            {
                return BadRequest(Result<bool>.CreateFailure(new string[] { "Please do not delete the default role." }));
            }
                ...
                if (result.Success)
                {
                    ...
                    foreach (var item in importItems)
                    {
                        ...
                        if (!(await _roleManager.RoleExistsAsync(role.Name)))
                        {
                            ...
                            {
                                return BadRequest(Result<bool>.CreateFailure(iresult.Errors.Select(x => x.Description)));
                            }
                        }
                    }
                }
