...
using Application.Documents.Queries.Export;
using Application.Documents.Queries.PaginationQuery;
using MediatR;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.RazorPages;
using Microsoft.Extensions.Localization;
using Application.DocumentTypes.Queries.PaginationQuery;
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (UploadedFile != null)
            {
                ...
                Input.UploadRequest.UploadType = Domain.Enums.UploadType.Document;
